# Open source WIFI module replacement for Gree/Sinclair/Daizuki/TGM AC units for Home Assistant.
...
1) I fixed the fan mode, mine works now for Gree/Daizuki/TGM AC's.
