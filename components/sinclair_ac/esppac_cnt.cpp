...
void SinclairACCNT::send_packet()
{
    ...
    if (this->fan_mode == fan_modes::FAN_AUTO)
    {
        fanSpeed1 = 0;
        fanSpeed2 = 0;
        fanQuiet  = false;
    ...
    else if (this->fan_mode == fan_modes::FAN_LOW)
    {
        fanSpeed1 = 1;
        fanSpeed2 = 1;
        fanQuiet  = false;
...
/*    else if (this->fan_mode == fan_modes::FAN_QUIET)
    {
        fanSpeed1 = 1;
        fanSpeed2 = 1;
        fanQuiet  = true;
    ...
    else if (this->fan_mode == fan_modes::FAN_MED)
    {
        fanSpeed1 = 3;
        fanSpeed2 = 2;
        fanQuiet  = false;
    ...
    else if (this->fan_mode == fan_modes::FAN_HIGH)
    {
        fanSpeed1 = 5;
        fanSpeed2 = 3;
        fanQuiet  = false;
    ...
    else if (this->fan_mode == fan_modes::FAN_TURBO)
    {
        fanSpeed1 = 5;
        fanSpeed2 = 3;
        fanQuiet  = false;
